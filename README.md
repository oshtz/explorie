...
The v0.2.1 draft contains `explorie-0.2.1-windows-x64-setup-unsigned.exe`, `explorie-0.2.1-macos-arm64.dmg`, `SHA256SUMS-windows.txt`, and `SHA256SUMS-macos.txt`.
...
- Uninstall v0.1.0 before installing v0.2.1; the permanent `com.omershatz.explorie` identity intentionally starts a clean installation lineage.
